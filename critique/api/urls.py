...
urlpatterns = [
    ...
    path('artworks/<int:artwork_id>/versions/<int:version_id>/', ArtworkVersionViewSet.as_view({'delete': 'delete'}), name='artwork-version-delete'),
    path('artworks/versions/<int:version_id>/delete/', delete_artwork_version, name='artwork-version-delete-legacy'),
