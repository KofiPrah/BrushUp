...
from . import views
from .views import password_management
...
urlpatterns = [
    ...
    path('profile/password/', password_management.profile_password_management, name='profile_password_management'),
    ...
    path('api/auth/status/', password_management.get_user_auth_status, name='user_auth_status'),
    path('api/auth/send-password-reset/', password_management.send_password_reset_to_oauth_user, name='send_password_reset_oauth'),
