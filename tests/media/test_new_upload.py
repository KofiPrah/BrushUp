"""
Test script for new image upload with updated S3 permissions
"""
import os
import django
...
def create_test_image(filename="test_new_permissions.jpg", size_kb=20):
...
def upload_new_image():
    """Upload a test image with new permissions settings"""
    print("\n=== Testing S3 Permissions Fix ===")
    ...
    artwork = ArtWork.objects.create(
        title="Test S3 Permissions Fix",
        description="Testing our fix for S3 permissions and public access to images",
        author=user,
        medium="Digital",
        dimensions="800x600",
        tags="test,permissions,s3",
        image=SimpleUploadedFile(
            name="test_new_permissions.jpg",
    ...
    if artwork.image:
        ...
        print("If it works, our fix for the S3 permissions issue was successful!")
    else:
